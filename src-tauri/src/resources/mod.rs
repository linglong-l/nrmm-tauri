...
pub const LISTEN_KEYPRESS_ADDITIONAL_WINDOW: &[u8] =
    include_bytes!("listen_keypress_additional_window.txt");
/// 后台按键监听配置
pub const LISTEN_KEYPRESS_EVEN_ON_BACKGROUND: &[u8] =
    include_bytes!("listen_keypress_even_on_background.txt");
